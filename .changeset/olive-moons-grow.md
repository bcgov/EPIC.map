...
it was left. The kebab renames a folder, ungroups every layer in it, or deletes
it; deleting is never destructive to what is starred — the layers come back out
...
above the list instead of looking like folders that were deleted.
